...
<!-- AUTO-GENERATED from agents/proactive-scout.md by scripts/sync-agents.sh. DO NOT EDIT MANUALLY. -->
...
- **docs/iterations/current/product/PRD-*.md：** 需求文档是否过时？
- **测试覆盖：** 核心功能是否有测试？
...
侦察报告，输出到 docs/iterations/current/scout/SCOUT-001-侦察报告.md
